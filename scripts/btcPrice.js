...
var BTCPrice = /** @class */ (function () {
    ...
    BTCPrice.prototype.registerListener = function (robot) {
        var _this = this;
        return robot.hear(/btc|bitcoin|batcoin/i, function (res) { return __awaiter(_this, void 0, void 0, function () {
            var data, priceUSD, message, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        data = _a.sent();
                        priceUSD = data.bpi.USD.rate_float;
                        if (!priceUSD) {
                            throw new Error("No price in response from " + endpoint);
                        }
                        message = "1 BTC = " + commas(priceUSD.toFixed(2)) + " USD";
                        res.send(message);
                        return [3 /*break*/, 3];
                    case 2:
                        err_1 = _a.sent();
